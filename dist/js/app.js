...
***************************************************************************** */
        ...
        function header_scroll_headerScroll() {
        ...
        async function showMoreProducts(button) {
        ...
        window.onload = function() {
            ...
            function documentActions(e) {
                ...
                if (window.innerWidth > 768 && isMobile.any()) {
                    ...
                    if (!targetElement?.classList.contains("menu__arrow") && document.querySelectorAll(".menu__item._hover").length > 0) removeClasses(document.querySelectorAll(".menu__item._hover"), "_hover");
                }
